...
public class EnemySpawner : MonoBehaviour
{
    ...
    void StartNextWave()
    {
        ...
        // เรียกเสียงเมื่อปล่อยศัตรู
        if (SoundManager.instance != null)
        {
            SoundManager.instance.PlaySpawnEnemySound();
        }
    ...
    void UpdateUI()
    {
        ...
        liveCountdownText.text = "Enemy Live: " + remainingEnemies;
    }
    ...
    void ShowWinCanvas()
    {
        ...
        if (SoundManager.instance != null)
        {
            SoundManager.instance.PlayWinSound(); // เรียกใช้เสียงชนะ
        }
